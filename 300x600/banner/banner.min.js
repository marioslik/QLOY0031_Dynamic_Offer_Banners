...
function initCSS() {
    ...
    TweenMax.set($("#logos-container"), {y:16});
...
function startAnimation() {
    ...
    tl.to("#white-grad-small-stop-01", 2, {stopOpacity:1, stopColor:"#FFFFFF", ease:Power1.easeInOut}, "frame03+=1");
    tl.to("#white-grad-small-stop-02", 2, {stopOpacity:1, stopColor:"#FFFFFF", ease:Power1.easeInOut}, "frame03+=1");
    tl.to("#white-grad-small-stop-03", 2, {stopOpacity:1, stopColor:"#FFFFFF", ease:Power1.easeInOut}, "frame03+=1");
    ...
    tl.to("#red-gradient", 3.5, {autoAlpha:1, rotation:81, x:-121, y:-65, scale:1, ease: Power1.easeInOut}, "frame03+=.2");


    //END FRAME  ------------------------------------------------
    tl.add("endFrame", 13);
    tl.to("#partnership-white-shape-small", 2, {autoAlpha:1, x:-300, y:10, scaleX:2.2, ease: Power1.easeIn}, "endFrame");
    tl.fromTo("#partnership-white-shape", 3, {x:40, y:75, rotation:20,}, {x:40, y:60, rotation:0, ease: Power2.easeInOut}, "endFrame-=.5");
    ...
    tl.from(".partner-logo", 1.5, {alpha:0, ease: Power1.easeInOut}, "endFrame+=2");
    tl.from(".logo-divider-line", 1.5, {alpha: 0, scaleY:0, transformOrigin: "50% 100%", ease: Power1.easeInOut}, "endFrame+=1.5");

    tl.to(".qantas-logo", 1.2, {scale:0.7, ease: Power1.easeInOut}, "endFrame+=1.3");
    tl.to("#logos-container", 1.5, {x:-55, ease: Power1.easeInOut}, "endFrame+=1.3");
